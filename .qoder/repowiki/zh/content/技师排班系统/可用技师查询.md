...
## 更新摘要
**变更内容**
- 修正了 getHistoryData 云函数中的销售佣金计算数学错误
- 优化了多个销售人员参与同一笔会员销售时的佣金分配算法
- 采用 `Math.floor()` 确保佣金分配更加准确和公平
- 增强了销售佣金计算的精确性和一致性
...
GHD["getHistoryData/index.js<br/>历史数据与销售统计"]
end
subgraph "数据库集合"
STAFF["staff"]
SCHEDULE["schedule"]
...
**图表来源**
- [cloudfunctions/getAvailableTechnicians/index.js:26-164](file://cloudfunctions/getAvailableTechnicians/index.js#L26-L164)
- [cloudfunctions/getHistoryData/index.js:354-381](file://cloudfunctions/getHistoryData/index.js#L354-L381)
- [miniprogram/pages/index/services/data-loader.service.ts:33-42](file://miniprogram/pages/index/services/data-loader.service.ts#L33-L42)
- [miniprogram/pages/index/utils/reservation-utils.ts:99-117](file://miniprogram/pages/index/utils/reservation-utils.ts#L99-L117)
- [miniprogram/utils/cloud-db.ts:93-123](file://miniprogram/utils/cloud-db.ts#L93-L123)
- [miniprogram/utils/util.ts:13-17](file://miniprogram/utils/util.ts#L13-L17)
- [miniprogram/app.ts:110-128](file://miniprogram/app.ts#L110-L128)
- [cloudfunctions/manageRotation/index.js:14-36](file://cloudfunctions/manageRotation/index.js#L14-L36)
...
- **销售佣金计算模块**：getHistoryData云函数中的佣金分配算法
- **前端调用方**：
...
**章节来源**
- [cloudfunctions/getAvailableTechnicians/index.js:26-164](file://cloudfunctions/getAvailableTechnicians/index.js#L26-L164)
- [cloudfunctions/getAvailableTechnicians/index.js:206-221](file://cloudfunctions/getAvailableTechnicians/index.js#L206-L221)
- [cloudfunctions/getAvailableTechnicians/index.js:9-24](file://cloudfunctions/getAvailableTechnicians/index.js#L9-L24)
- [cloudfunctions/getAvailableTechnicians/index.js:233-292](file://cloudfunctions/getAvailableTechnicians/index.js#L233-L292)
- [cloudfunctions/getAvailableTechnicians/index.js:303-452](file://cloudfunctions/getAvailableTechnicians/index.js#L303-L452)
- [cloudfunctions/getAvailableTechnicians/index.js:577-619](file://cloudfunctions/getAvailableTechnicians/index.js#L577-L619)
- [cloudfunctions/getHistoryData/index.js:362-381](file://cloudfunctions/getHistoryData/index.js#L362-L381)
- [miniprogram/pages/index/services/data-loader.service.ts:33-42](file://miniprogram/pages/index/services/data-loader.service.ts#L33-L42)
- [miniprogram/pages/index/utils/reservation-utils.ts:99-117](file://miniprogram/pages/index/utils/reservation-utils.ts#L99-L117)
- [miniprogram/utils/cloud-db.ts:93-123](file://miniprogram/utils/cloud-db.ts#L93-L123)
- [miniprogram/utils/util.ts:13-17](file://miniprogram/utils/util.ts#L13-L17)
...
participant Hist as "getHistoryData"
...
WX-->>Page : 返回结果
Note over Hist,DB : 销售佣金计算独立于技师查询
Hist->>DB : 查询 customer_membership 和 consultation_records
Hist->>Hist : 计算销售佣金分配
Hist-->>WX : 返回{code, message, data}
```

**图表来源**
- [cloudfunctions/getAvailableTechnicians/index.js:26-164](file://cloudfunctions/getAvailableTechnicians/index.js#L26-L164)
- [cloudfunctions/getAvailableTechnicians/index.js:458-567](file://cloudfunctions/getAvailableTechnicians/index.js#L458-L567)
- [cloudfunctions/getAvailableTechnicians/index.js:621-640](file://cloudfunctions/getAvailableTechnicians/index.js#L621-L640)
- [cloudfunctions/getAvailableTechnicians/index.js:206-221](file://cloudfunctions/getAvailableTechnicians/index.js#L206-L221)
- [cloudfunctions/getHistoryData/index.js:362-381](file://cloudfunctions/getHistoryData/index.js#L362-L381)
...
**章节来源**
- [cloudfunctions/getAvailableTechnicians/index.js:27-42](file://cloudfunctions/getAvailableTechnicians/index.js#L27-L42)
- [miniprogram/utils/util.ts:13-17](file://miniprogram/utils/util.ts#L13-L17)
- [miniprogram/pages/index/services/data-loader.service.ts:33-42](file://miniprogram/pages/index/services/data-loader.service.ts#L33-L42)
- [miniprogram/pages/index/utils/reservation-utils.ts:99-117](file://miniprogram/pages/index/utils/reservation-utils.ts#L99-L117)
...
**图表来源**
- [cloudfunctions/getAvailableTechnicians/index.js:91-151](file://cloudfunctions/getAvailableTechnicians/index.js#L91-L151)
- [cloudfunctions/getAvailableTechnicians/index.js:658-683](file://cloudfunctions/getAvailableTechnicians/index.js#L658-L683)
...
### 销售佣金计算修复
**重要更新**：修正了多个销售人员参与同一笔会员销售时的佣金分配算法

- **问题背景**
  - 原始算法可能存在除法运算的精度问题
  - 多个销售人员共同参与同一笔会员销售时，佣金分配不够精确
- **修复方案**
  - 使用 `Math.floor(cardTimes / staffCount)` 确保佣金分配的准确性
  - 每个销售人员获得整数倍的次卡数量
  - 避免小数部分造成的分配不均
- **计算逻辑**
  - `cardTimes`：会员卡的总次卡数量
  - `staffCount`：参与销售的销售人员数量
  - `timesPerStaff`：每个销售人员应得的次卡数量
  - 使用向下取整确保分配的公平性
...
**章节来源**
- [cloudfunctions/getAvailableTechnicians/index.js:27-42](file://cloudfunctions/getAvailableTechnicians/index.js#L27-L42)
- [cloudfunctions/getAvailableTechnicians/index.js:153-163](file://cloudfunctions/getAvailableTechnicians/index.js#L153-L163)
- [cloudfunctions/getAvailableTechnicians/index.js:621-640](file://cloudfunctions/getAvailableTechnicians/index.js#L621-L640)
- [cloudfunctions/getAvailableTechnicians/index.js:458-567](file://cloudfunctions/getAvailableTechnicians/index.js#L458-L567)
...
UT["util.ts"] --> DL
APP["app.ts"] --> RU
GHD["getHistoryData/index.js"] --> MEM["customer_membership 集合"]
GHD --> CONS
GHD --> STAFF
```

**图表来源**
- [cloudfunctions/getAvailableTechnicians/index.js:47-84](file://cloudfunctions/getAvailableTechnicians/index.js#L47-L84)
- [cloudfunctions/getHistoryData/index.js:354-381](file://cloudfunctions/getHistoryData/index.js#L354-L381)
- [miniprogram/pages/index/services/data-loader.service.ts:33-42](file://miniprogram/pages/index/services/data-loader.service.ts#L33-L42)
- [miniprogram/pages/index/utils/reservation-utils.ts:99-117](file://miniprogram/pages/index/utils/reservation-utils.ts#L99-L117)
- [miniprogram/utils/cloud-db.ts:93-123](file://miniprogram/utils/cloud-db.ts#L93-L123)
...
**章节来源**
- [cloudfunctions/getAll/index.js:7-44](file://cloudfunctions/getAll/index.js#L7-L44)
- [cloudfunctions/getAvailableTechnicians/index.js:464-469](file://cloudfunctions/getAvailableTechnicians/index.js#L464-L469)
- [cloudfunctions/getAvailableTechnicians/index.js:626-631](file://cloudfunctions/getAvailableTechnicians/index.js#L626-L631)
...
**章节来源**
- [cloudfunctions/getAvailableTechnicians/index.js:37-42](file://cloudfunctions/getAvailableTechnicians/index.js#L37-L42)
- [cloudfunctions/getAvailableTechnicians/index.js:158-163](file://cloudfunctions/getAvailableTechnicians/index.js#L158-L163)
- [cloudfunctions/manageRotation/index.js:38-72](file://cloudfunctions/manageRotation/index.js#L38-L72)
...
**重要更新**：销售佣金计算模块经过数学算法优化，确保多个销售人员参与同一笔会员销售时的佣金分配更加准确和公平，采用 `Math.floor()` 确保分配的精确性和一致性。
...
- **销售佣金相关类型**
  - MembershipRecord、SalesStaff、CommissionAllocation
- **微信小程序类型声明**
  - wx 命名空间下的类型定义

**章节来源**
- [typings/index.d.ts:37-83](file://typings/index.d.ts#L37-L83)
- [typings/index.d.ts:308-354](file://typings/index.d.ts#L308-L354)
- [typings/index.d.ts:505-508](file://typings/index.d.ts#L505-L508)
- [typings/types/wx/index.d.ts:33-77](file://typings/types/wx/index.d.ts#L33-L77)
...
- **销售佣金计算修复**：Math.floor()确保佣金分配的准确性

**章节来源**
- [cloudfunctions/getAvailableTechnicians/index.js:26-35](file://cloudfunctions/getAvailableTechnicians/index.js#L26-L35)
- [cloudfunctions/getAvailableTechnicians/index.js:206-221](file://cloudfunctions/getAvailableTechnicians/index.js#L206-L221)
- [cloudfunctions/getAvailableTechnicians/index.js:9-24](file://cloudfunctions/getAvailableTechnicians/index.js#L9-L24)
- [cloudfunctions/getAvailableTechnicians/index.js:233-292](file://cloudfunctions/getAvailableTechnicians/index.js#L233-L292)
- [cloudfunctions/getAvailableTechnicians/index.js:303-452](file://cloudfunctions/getAvailableTechnicians/index.js#L303-L452)
